...
from .serializers_optimized import SerializerRegistry
...
class OrderViewSet(OptimizedBaseViewSet):
    ...
    serializer_classes = {
        ...
        'update': SerializerRegistry.get_order_serializer('update'),
        'partial_update': SerializerRegistry.get_order_serializer('update'),
        'retrieve': SerializerRegistry.get_order_serializer('retrieve'),
        'default': SerializerRegistry.get_order_serializer('default')
    }
...
class SellerViewSet(OptimizedBaseViewSet):
    ...
    # Serializer configuration
    serializer_classes = {
        'list': SerializerRegistry.get_seller_serializer('list'),
        'retrieve': SerializerRegistry.get_seller_serializer('retrieve'),
        'default': SerializerRegistry.get_seller_serializer('default')
    }
...
class CustomerFeedbackViewSet(OptimizedBaseViewSet):
    ...
    serializer_class = SerializerRegistry.get_serializer('CustomerFeedbackSerializer')
